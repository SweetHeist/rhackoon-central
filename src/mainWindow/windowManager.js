...
class Window {
    ...
    Initialize(lock_id) {
        ...
        this.#dom_window.addEventListener('focus', () => {
            this.#focus = true;
            /* console.debug("POP FOCUS") */
        });

        this.#dom_window.addEventListener('blur', () => {
            this.#focus = false;
            /* console.debug("POP BLUR") */
        });
        ...
        return new Promise(r => {
            ...
            this.#dom_window.addEventListener('load', () => {
                setTimeout(() => {
                    ...
                    this.#mainElement = this.#dom_window.document.createElement('button');
                    //this.#dom_window.document.body.append(this.#mainElement);
    ...
    UpdateMainElement() {
        if (this.#mainElement) {
            this.#mainElement.width = this.#dom_window.innerWidth;
            this.#mainElement.height = this.#dom_window.innerHeight;
        }
    }
    OnWindowResized() {
    ...
    Update(context) {
        if (this.IsFocused()) {
            const input = context.InputManager(); // TODO: context
